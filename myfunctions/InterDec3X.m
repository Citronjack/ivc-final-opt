function [I_rec] = InterDec3X( I_run, img_size , qScale, EOB )
...
%   Detailed explanation goes here
    ...
    %% Dequantize
    I_dequant = blockproc(I_depred, [8,8], @(block_struct) DeQuant8x8(block_struct.data, qScale));
    %% IDCT
    I_rec = blockproc(I_dequant, [8,8], @(block_struct) IDCT8x8(block_struct.data)); 
